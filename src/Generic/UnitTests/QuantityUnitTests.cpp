...
using QuantityTypes = boost::mpl::list< Herd::Generic::Luminosity, Herd::Generic::Mass, Herd::Generic::Metallicity, Herd::Generic::Radius, Herd::Generic::Time, Herd::Generic::AngularMomentum, Herd::Generic::AngularVelocity >;
