...
def run_sse(mass, z, age, sse_dir, output_dir):
    """ Runs SSE with the specified parameters
    """
    ...
    # SSE binary needs evolve.in in the current working directory, and also
    # writes evolve.dat there
    os.chdir(output_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--mass', dest='mass',
                        default='1', help='Initial mass')
    parser.add_argument('-z', '--metallicity', dest='z',
                        default='0.02', help='Metallicity')
    parser.add_argument('-a', '--age', dest='age',
                        default='7000', help='Age in Myears')
